...
QUnit.test("selftest: example", function(assert) {
	...
	assert.equal(0, false, "equal 0 == false");
	assert.notStrictEqual(0, false, "notStrictEqual 0 === false");		//Compare the value of two primitives, having the same value and type.
});